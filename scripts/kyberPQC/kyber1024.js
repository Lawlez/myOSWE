/*****************************************************************************************************************************/
//ORiginal Code from https://github.com/antontutoveanu/crystals-kyber-javascript
...
const pk_sk = KeyGen1024()
console.log(pk_sk[0])
const c_ss = Encrypt1024(pk_sk[0])
console.log(c_ss[1])
const newx = Decrypt1024(c_ss[0],pk_sk[1])
console.log(newx)
//console.log(Decrypt1024(x))
